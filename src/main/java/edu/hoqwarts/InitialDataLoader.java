    ...
    private void initializeHouses() {
        if (houseRepository.count() == 0) {
            houseRepository.saveAll(List.of(
                    new House("Gryffindor", "Godric Gryffindor", "Red", "Gold"),
                    new House("Slytherin", "Salazar Slytherin", "Green", "Silver"),
                    new House("Hufflepuff", "Helga Hufflepuff", "Yellow", "Black"),
                    new House("Ravenclaw", "Rowena Ravenclaw", "Blue", "Bronze")
            ));
        }
    }
    ...
    private void initializeCourses() {
        if (courseRepository.count() == 0) {
            ...
            List<Course> courses = List.of(
                    new Course("Potions", 1, true, teachers.get(0), students.subList(0, 5)),
                    new Course("Charms", 5, true, teachers.get(1), students.subList(2, 4)),
                    new Course("Transfiguration", 3, false, teachers.get(2), students.subList(1, 4)),
                    new Course("Defense Against the Dark Arts", 2, false, teachers.get(3), students.subList(6, 9)),
                    new Course("Herbology", 5, true, teachers.get(4), students.subList(0, 6))
            );
